        ...
        <div className="flex items-center gap-1 sm:gap-3">
          {currentUserEmail && (
            <div className="flex items-center gap-1.5 sm:gap-2 bg-zinc-900/85 px-1.5 sm:px-3 py-1 sm:py-1.5 rounded-xl border border-zinc-800 shadow-md">
              ...
              <span className="text-[9px] sm:text-xs font-mono text-zinc-300 font-semibold truncate max-w-[180px] sm:max-w-[280px]" title={currentUserEmail}>
                {currentUserEmail}
              </span>
            </div>
          )}
          ...
          {isPremium ? (
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 text-xs font-bold text-emerald-400 bg-emerald-950/40 border border-emerald-500/30 rounded-full hover:bg-emerald-950 hover:scale-[1.02] transition-all cursor-pointer animate-pulse shrink-0"
              title="Gérer mon abonnement Premium / Résiliation"
            >
              <Sparkles size={12} className="text-emerald-400 mr-0.5 shrink-0" />
              <span>Membre PRO ✨</span>
            </button>
          ) : (
            <button
              onClick={() => setIsCheckoutOpen(true)}
              className="flex items-center gap-1 px-3 py-1.5 text-xs font-bold text-amber-400 bg-amber-95/30 border border-amber-500/20 rounded-full hover:bg-amber-950 hover:scale-[1.02] transition-all cursor-pointer shrink-0"
              title="S'abonner à SmartScan PRO"
            >
              <Sparkles size={12} className="text-amber-400 mr-0.5 shrink-0" />
          ...
          >
            ...
            <div className="space-y-1.5 flex-1">
              ...
              <p className="text-[11px] leading-relaxed opacity-95">
                ...
                {syncError && (
                  <span className="block mt-1 font-mono text-[10px] bg-red-950/70 p-2 rounded border border-red-900/40 text-red-300">
