...
export default function ReceiptDetailsModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header decoration */}
        <div className="p-4 sm:p-6 bg-zinc-950 border-b border-zinc-700 flex items-center justify-between gap-4">
        ...
        <div className="p-4 sm:p-6 overflow-y-auto space-y-4 sm:space-y-6 flex-1 bg-zinc-900">
          ...
          {/* AI Insights Card */}
          {receipt.rawResponse && (
            <div className="bg-emerald-955/20 border-2 border-emerald-500/30 rounded-2xl p-4 relative overflow-hidden">
          ...
          <div className="border-2 border-zinc-700 rounded-2xl bg-zinc-955/90 p-5 space-y-4 shadow-xl">
            ...
            <div className="flex justify-start">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 border border-zinc-700 hover:border-zinc-650 bg-zinc-900 hover:bg-zinc-850 hover:text-white rounded-xl text-[10px] font-bold text-zinc-400 transition-all cursor-pointer"
              >
        ...
        <div className="p-4 sm:p-6 bg-zinc-955 border-t border-zinc-700 flex flex-col-reverse sm:flex-row gap-3 sm:items-center sm:justify-between">
          <button
            type="button"
            onClick={() => {
              onDelete(receipt.id);
