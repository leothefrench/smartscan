  ...
  const handleRequestOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        ...
        setErrorMessage(
          data.error || "Échec d'envoi du code. Veuillez réessayer.",
        );
        return;
      }
      ...
      setErrorMessage(
        'Impossible de joindre le serveur de sécurité. Vérifiez votre connexion.',
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleVerifyOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok || !data.success) {
        ...
        setErrorMessage(data.error || 'Le code saisi est incorrect ou expiré.');
        return;
      }
      ...
      setErrorMessage('Impossible de contacter le service de vérification.');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="text-center space-y-2 mb-8">
          ...
          <p className="text-xs text-slate-400 max-w-xs mx-auto">
            ...
            Simple, ultra-rapide et gratuit.
          </p>
        </div>
