              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs font-semibold text-zinc-300">
                  <span className="flex items-center gap-1">
                    <Coffee size={13} className="text-zinc-500" /> Cafés / Encas
                    extérieurs
                  </span>
          ...
          <div>
            ...
            <div className="space-y-2 text-[11px] text-zinc-300">
              <div className="flex items-start gap-1.5">
                ...
                <span>
                  <strong>Analyses & Scans Illimités</strong> (Analyse en temps
                  réel de tous vos reçus)
                </span>
              </div>
              <div className="flex items-start gap-1.5">
                <Check size={12} className="text-amber-400 shrink-0 mt-0.5" />
              ...
              <div className="flex items-start gap-1.5">
                <Check size={12} className="text-amber-400 shrink-0 mt-0.5" />
                <span>
                  <strong>Abonnements Fantômes</strong> (Détection intelligente
                  de frais récurrents cachés)
                </span>
              </div>
              <div className="flex items-start gap-1.5">
                <Check size={12} className="text-amber-400 shrink-0 mt-0.5" />
                <span>
                  <strong>Multi-Appareils Cloud</strong> (Accès et sauvegarde
