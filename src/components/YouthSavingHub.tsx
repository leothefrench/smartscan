...
import { Sparkles, Coins, Coffee, Smartphone, Target, Zap, CheckCircle2, Award, ArrowRight, ShieldCheck, Check } from "lucide-react";
...
export default function YouthSavingHub({ receipts }: YouthSavingHubProps) {
  ...
  const [isSimulatingPremium, setIsSimulatingPremium] = useState<boolean>(false);
    ...
    <div className="space-y-6" id="youth-saving-hub">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 flex flex-col justify-between" id="micro-spend-card">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs font-semibold text-zinc-300">
                  ...
                  <span className="text-white bg-zinc-950 px-2 py-0.5 rounded font-mono text-[10px] border border-zinc-850">
                    {coffeeCount} / sem
                  </span>
                </div>
                <input 
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between text-xs font-semibold text-zinc-300">
                  <span className="flex items-center gap-1">
                    <Smartphone size={13} className="text-zinc-500" /> Abonnements actifs
                  </span>
                  <span className="text-white bg-zinc-950 px-2 py-0.5 rounded font-mono text-[10px] border border-zinc-850">
                    {subsCount} services
                  </span>
          ...
          <div className="mt-6 pt-4 border-t border-zinc-850 space-y-1.5">
            ...
            <p className="text-[9px] text-zinc-500 leading-normal italic text-center pt-2 select-none border-t border-dashed border-zinc-850">
        ...
        <div className="bg-gradient-to-br from-zinc-900 via-zinc-900 to-amber-950/20 rounded-2xl p-6 border border-amber-500/20 flex flex-col justify-between relative overflow-hidden" id="premium-proposal-card">
          ...
          <div>
            ...
            <div className="bg-zinc-950/80 rounded-xl p-3 border border-zinc-850 flex items-center justify-between mb-4">
              <div>
                <span className="text-xs text-zinc-400 font-semibold block leading-tight">Abonnement Mensuel</span>
                <span className="text-[10px] text-zinc-500 font-semibold">Sans engagement, résiliation en ligne</span>
              </div>
              <div className="text-right">
                <span className="text-lg font-black text-amber-400 font-mono">4,99 €</span>
                <span className="text-[10px] text-zinc-400 font-medium block leading-none">/ mois</span>
              </div>
            </div>
